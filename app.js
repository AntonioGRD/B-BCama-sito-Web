...
const TRANSLATIONS = {
  ...
  es: {
    ...
    heroBtnPernottamento: 'Alojamiento',
    heroBtnDayUse: 'Day Use (3 Horas)',
    heroFeatFloor: '5ª Planta con Ascensor',
    heroFeatBath: 'Baño Privado En-Suite',
    heroFeatBalcony: 'Balcón Panorámico',
    heroFeatBreakfast: 'Desayuno Incluido',
    homeStayTitle: 'Alojamiento',
    homeStayDesc: 'Estancia clásica en elegantes habitaciones dobles en la 5ª planta con ascensor, baño privado, Smart TV y terraza panorámica.',
    homeDayUseTitle: 'Day Use (3 Horas)',
    homeDayUseDesc: 'Habitación privada diurna durante 3 horas de total privacidad con baño privado en-suite, balcón y climatización.',
    // Quiénes Somos
    aboutBadge: 'Una Historia de Familia y Corazón',
    ...
    aboutText1: 'Un nombre que encierra un doble y emotivo significado: además de representar las iniciales de nuestro padre, <strong>"Cama"</strong> simboliza descanso, confort, acogida y calidez familiar. CaMa B&B es mucho más que un simple alojamiento: es una historia de familia, un lugar donde sentirse como en casa.',
    aboutFeature1Title: '5ª Planta',
    ...
    sectionRoomsDesc: 'En el corazón de Gragnano, elegantes habitaciones de matrimonio en la 5ª planta con ascensor y vistas panorámicas a los Montes Lattari, equipadas con todas las comodidades:',
    ...
    featTowelsTitle: 'Juego de Toallas',
    featTowelsSub: '3 piezas por persona',
    featAmenitiesTitle: 'Amenities y Secador',
    featAmenitiesSub: 'Secador de pelo incluido',
    featTechTitle: 'Clima & Wi-Fi',
    ...
    stabiaTag2: 'Balcón Panorámico con Vistas al Golfo y al Vesubio',
    ...
    roomRateFrom: 'Tarifa',
    contactForPrice: 'Consultar tarifa',
    ...
    dayUseDesc: 'La comodidad y total privacidad de una habitación privada en la 5ª planta para unas horas de relax: baño en-suite con ducha, balcón panorámico con vistas a los Montes Lattari, Smart TV, Wi-Fi fibra y climatizzazione autonoma.',
    dayUseFeat1: '3 Horas de Total Privacidad',
    dayUseFeat2: 'Baño Privado En-Suite',
    dayUseFeat3: 'Vistas Panorámicas y Ascensor',
    dayUseImmediate: 'Disponibilidad inmediata bajo petición',
    ...
    amenityKit: 'Juego de Toallas (3 pzs/persona), Jabones y Secador',
    ...
    bookSubtitle: 'Selecciona las fechas para calcular la tarifa y enviar la solicitud',
    ...
    contactPhoneLabel: 'Atención Host & Recepción 24/7',
    directContactTitle: 'Contacto Directo',
    directContactDesc: 'Respondemos en tiempo real por WhatsApp y por teléfono para brindarte disponibilidad actualizada, tarifas dedicadas y recomendaciones exclusivas para tu viaje.',
    contactMobileLabel: 'Móvil / WhatsApp:',
    ...
    contactLocationTitle: 'Sede y Alojamiento',
    ...
    contactFloor: '5ª Planta con Ascensor',
    contactHoursTitle: 'Horario de Atención',
    contactChannelsTitle: 'Canales Oficiales',
    contactWhatsAppAction: 'Chat WhatsApp Directo',
    contactCallAction: 'Llamar Ahora',
    ...
    locDistancesTitle: 'Distancias Principales',
    distPompei: 'Ruinas de Pompeya',
    distCastellammare: 'Castellammare (Ferries)',
    distSorrento: 'Sorrento y Costa',
    distNapoli: 'Aeropuerto de Nápoles',
    btnGoogleMaps: 'Abrir Ubicación en Google Maps',
    footerContactsHours: 'Contacto y Horarios',
    ...
    modalSubtitle: 'Envía la solicitud directamente al anfitrión de B&B CaMa',
    modalDatesLabel: 'Fechas:',
    inputNamePh: 'Nombre y Apellidos *',
    inputPhonePh: 'Teléfono *',
    inputEmailPh: 'Email *',
    badgeNecessary: 'Necesarias',
