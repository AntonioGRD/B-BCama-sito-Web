...
const TRANSLATIONS = {
  it: {
    ...
    pompeiDesc: 'Elegante camera dotata di confortevole letto matrimoniale, bagno privato en-suite con doccia, climatizzazione autonoma, Smart TV e Wi-Fi veloce. Ideale per un soggiorno di totale relax e tranquillità.',
    pompeiTag1: 'Letto Matrimoniale',
    pompeiTag2: 'Bagno Privato En-Suite',
    pompeiTag3: 'Clima & Smart TV',
    // Stabia Sunset
    stabiaType: 'Matrimoniale con Balcone',
    stabiaDesc: 'La sistemazione più suggestiva e panoramica: dotata di confortevole letto matrimoniale e balcone privato con vista sui Monti Lattari. Include bagno privato en-suite, climatizzazione autonoma, Smart TV e kit di benvenuto.',
    ...
    vesuviewDesc: 'Splendida camera dotata di confortevole letto matrimoniale per 2 ospiti e balcone panoramico. Completa di bagno privato en-suite con doccia, Smart TV, Wi-Fi fibra e climatizzazione autonoma per un soggiorno esclusivo.',
  ...
  en: {
    ...
    pompeiDesc: 'Elegant bedroom featuring a comfortable double bed, private en-suite bathroom with shower, autonomous air conditioning, Smart TV, and fast Wi-Fi. Ideal for relaxing after exploring Pompeii and the Coast.',
    pompeiTag1: 'Double Bed',
    pompeiTag2: 'En-Suite Bathroom',
    pompeiTag3: 'A/C & Smart TV',
    // Stabia Sunset
    stabiaType: 'Double with Scenic Balcony',
    stabiaDesc: 'Our most scenic accommodation: featuring a comfortable double bed and a private balcony overlooking the Lattari Mountains. Equipped with private en-suite bathroom, autonomous climate control, Smart TV, and welcome amenities.',
    stabiaTag1: 'Double Bed',
    stabiaTag2: 'Panoramic Balcony',
    stabiaTag3: 'En-Suite Bathroom',
    // VesuView
    vesuviewType: 'Double with Panoramic Balcony',
    vesuviewDesc: 'Charming double bedroom for 2 guests, with comfortable double bed and scenic panoramic balcony. Features modern en-suite private bathroom, fiber Wi-Fi, Smart TV, and autonomous climate control.',
  ...
  es: {
    ...
    pompeiDesc: 'Elegante habitación con cómoda cama de matrimonio, baño privado en-suite con ducha, climatización autónoma, Smart TV y Wi-Fi de alta velocidad. Ideal para una estancia de descanso y tranquilidad.',
    pompeiTag1: 'Cama de Matrimonio',
    pompeiTag2: 'Baño Privado En-Suite',
    pompeiTag3: 'Clima & Smart TV',
    // Stabia Sunset
    stabiaType: 'Matrimonial con Balcón Panorámico',
    stabiaDesc: 'El alojamiento más sugerente y panorámico: con cómoda cama de matrimonio y balcón privado con vistas a los Montes Lattari. Incluye baño privado en-suite, climatización autónoma, Smart TV y set de cortesía.',
    ...
    vesuviewDesc: 'Espléndida habitación con cómoda cama de matrimonio para 2 personas y balcón panorámico. Equipada con baño privado en-suite con ducha, Smart TV, Wi-Fi fibra y climatización autónoma.',
